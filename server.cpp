...
static void *interfata(void * arg)
{
    int c;
    cout<<"Afisare utilizatori conectati - 1"<<endl;
    cout<<"Iesire - 0"<<endl;
    ...
    while(true)
    {
       ...
       {
           cout<<"Utilizatorii conectati sunt: ";
           for_each(connectedUsers.begin(), connectedUsers.end(), [](string s){
               cout<<s<<" ";
           });
       }
       cout<<endl;
...
void raspunde(void *arg)
{
    ...
    if (write (tdL.cl, mesaj, sizeof(char) * strlen(mesaj)) <= 0)
    {
